...
const projects = [
  {
    ...
    seed: "mirrormirror",
    url: "https://mirror-mirror-wheat.vercel.app/"
  },
  {
  ...
  },
  {
    ...
    description: "Professionele website voor mijn eigen bedrijf met diensten, projecten en portfolio in modern design.",
    seed: "flaaredbusiness",
    url: "#"
  },
  {
    title: "Bank Applicatie",
    description: "Veilige bankapplicatie met TypeScript voor accountbeheer en transacties met moderne UI.",
    seed: "bankapp",
    image: "/image.png",
    url: "#"
  },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {projects.map((project, index) => (
            ...
            >
              <img
                src={project.image || `https://picsum.photos/600/400?seed=${project.seed}`}
                alt={project.title}
                width={600}
                height={400}
                loading="lazy"
